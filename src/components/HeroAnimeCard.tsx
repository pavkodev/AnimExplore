...
const HeroAnimeCard = (props: {
  ...
  return (
    <div className="text-white">
      ...
      <div className="m-auto flex w-[80vw] flex-col items-center justify-center rounded border-2 border-orange-600 bg-gray-950 p-4 sm:w-fit lg:flex-row lg:p-0 lg:pr-4">
        <img
          src={props.image}
          alt="placeholder"
        ...
        <div className="mt-4 flex max-w-[50ch] flex-col items-center justify-center lg:ml-8">
          ...
          <p className="mb-8 hidden font-thin lg:block">
            {props.studios.join(", ")}
          </p>
          <p>
            <b>{props.type}</b>{" "}
          ...
          <p className="hidden lg:block">{props.synopsis}</p>
        </div>
      </div>
    </div>
  );
